...
$name = $_POST['search'];
$sql='SELECT * FROM products_info WHERE name like "%'.$name.'%"';
...
<body style="background-color: #fff4e6;">
      <h1 class="search-head">You searched for "<?php echo $name ?>"</h1>
    ...
    for($j=0;$j<count($result);$j++){
      ...
      echo '</p>';
      echo '<a href="#" class="card-btn">Add to Cart</a>';
      echo '</div>';
      echo '</div>';
    }
  }
  else{
    echo '<img src="./not-found.png" alt="" class="not-found-img"/>';
  }
  ?>
</body>
</html>